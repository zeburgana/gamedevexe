...
public class AchievementManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        CreateAchievement("General", "Get Moving", "all the movement keys", 10, 1, 0, new string[] { "Press W", "Press A", "Press S", "Press D" });
        CreateAchievement("General", "Press L", "Press L 3 times to unlock", 5, 1, 3);
